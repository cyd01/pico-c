...
LINKDLL int bcrypt_test_pattern( const char * pattern, const unsigned int pattern_length ) ;
...
LINKDLL int bcrypt_string_base64url( const char * st_in, char * st_out
	, const unsigned int length, const char * key, const unsigned int maxlinesize ) ;
LINKDLL int buncrypt_string_base64url( const char * st_in, char * st_out
	, const unsigned int length, const char * key ) ;
...
LINKDLL int bcrypt_file_base64url( const char * filename_in, const char * filename_out
	, const char * key, const unsigned int maxlinesize ) ;
LINKDLL int buncrypt_file_base64url( const char * filename, const char * filename_out
	, const char * key ) ;
